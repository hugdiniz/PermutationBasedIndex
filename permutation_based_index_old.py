class PermutationBasedIndex(InvertedIndex):
    def __init__(self, bucket_count, reference_set_size, prunning_size, ref_sel_threshold = 0.5,pivot_selection_function = reference_set_selection):
        self.bucket_count,self.reference_set_size,self.prunning_size,self.ref_sel_threshold,self.reference_set_selection = bucket_count,reference_set_size,prunning_size,ref_sel_threshold,reference_set_selection
