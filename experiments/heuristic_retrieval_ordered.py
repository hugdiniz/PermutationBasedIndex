...
#    queries_percentage = 90
    ...
    lshnns_parameters = {
        ...
        "lshnns__n_neighbors" : (1597, 3991,7983, 11975), # PAN11(EN, just queries with relevants) 10%, 25%, 50%, 75%,),# 1114,2787,5574,8361 Pan 10
#        "lshnns__n_neighbors" : (300,),
    ...
    pbinns_parameters = {
        ...
        "pbinns__punishment_type" : ('all_sides',),
        "pbinns__score_type" : ("spearmanFootrule",),
...
#     
    ...
    b.to_csv('%s%s_bm25_results.csv'%(today,dataset_name),sep='\t')    
